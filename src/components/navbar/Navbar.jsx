...
export default function Navbar() {
    return (
        <header className="flex justify-between lg:justify-around items-center p-3 shadow px-12 bg-gray-0 w-full border border-b-gray-700 border-l-transparent border-t-transparent border-r-transparent">
            <Link href="/">
